...
namespace Articy.Special_Assignment.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Special_Assignment.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Special_Assignment.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.Special_Assignment.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Special_Assignment.Features.DefaultExtendedCharacterFeatureFeature();

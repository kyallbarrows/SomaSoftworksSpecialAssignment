...
namespace Articy.Special_Assignment.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Special_Assignment.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Special_Assignment.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.Special_Assignment.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Special_Assignment.Features.DefaultBasicCharacterFeatureFeature();

...
namespace Articy.Special_Assignment.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Special_Assignment.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        public Articy.Special_Assignment.Features.DefaultBasicCharacterFeatureFeature DefaultBasicCharacterFeature
        {
            get
            {
        ...
        {
            Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.Special_Assignment.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
            if ((DefaultBasicCharacterFeature != null))
            {
                newClone.DefaultBasicCharacterFeature = ((Articy.Special_Assignment.Features.DefaultBasicCharacterFeatureFeature)(DefaultBasicCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplate();

...
namespace Articy.Special_Assignment
{
    ...
    public class DefaultMainCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultExtendedCharacterFeature, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplateConstraint mConstraints = new Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplateConstraint();
        
        public Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.Special_Assignment.Templates.DefaultMainCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
